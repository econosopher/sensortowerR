...
#'   results for all categories are typically returned. Use `st_categories()`
#'   to find valid IDs.
...
#' top_android_dau_delta <- st_top_active_users(
#'   os = "android",
...
#' # top_unified_apps <- st_top_active_users(
#' #   os = "unified",
#' #   comparison_attribute = "absolute",
#' #   time_range = "week",
#' #   measure = "WAU",
...
#' # top_unified_filtered <- st_top_active_users(
#' #   os = "unified",
#' #   comparison_attribute = "absolute",
#' #   time_range = "month",
#' #   measure = "MAU",
